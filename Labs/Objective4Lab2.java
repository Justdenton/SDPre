...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    // Program prompts the user for 3 integers and 3 doubles. 
    // The sum of each type is printed at the end, one line for integers and a second line for doubles.

    // Declare integers.
    int num1 = 0, num2 = 0, num3 = 0;

    // Integers (whole) prompts (initialize)
    ...
    //Double (decimals) prompts (initialize)
    ...
    // Prints the three ints and their sum.
    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + intSum);

    // Prints the three doubles and their sum.
